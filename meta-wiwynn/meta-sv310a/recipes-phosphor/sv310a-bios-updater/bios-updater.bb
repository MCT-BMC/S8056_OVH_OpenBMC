...
DEPENDS += "systemd sdbusplus obmc-libi2c libgpiod phosphor-dbus-interfaces obmc-libmisc obmc-libdbus"
RDEPENDS_${PN} += "libsystemd sdbusplus obmc-libi2c libgpiod obmc-libmisc obmc-libdbus"
